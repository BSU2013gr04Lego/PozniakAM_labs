...
QT_MOC_LITERAL(6, 69, 7)
    ...
    "ScreenSaver\0widthChanged\0\0heightChanged\0"
    "SlotMoveForward\0SlotMoveBack\0repaint"
};
...
void ScreenSaver::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 2: _t->SlotMoveForward(); break;
        case 3: _t->SlotMoveBack(); break;
        ...
        {
            typedef void (ScreenSaver::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ScreenSaver::widthChanged)) {
                *result = 0;
            }
        }
        {
            typedef void (ScreenSaver::*_t)(int );
            if (*reinterpret_cast<_t *>(func) == static_cast<_t>(&ScreenSaver::heightChanged)) {
                *result = 1;
            }
        }
    }
...
const QMetaObject ScreenSaver::staticMetaObject = {
    { &QGLWidget::staticMetaObject, qt_meta_stringdata_ScreenSaver.data,
      qt_meta_data_ScreenSaver,  qt_static_metacall, 0, 0}
};
...
// SIGNAL 0
void ScreenSaver::widthChanged(int _t1)
{
...
// SIGNAL 1
void ScreenSaver::heightChanged(int _t1)
{
    void *_a[] = { 0, const_cast<void*>(reinterpret_cast<const void*>(&_t1)) };
